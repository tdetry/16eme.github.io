...
function startCountdown(){
	...
	answerButton.setAttribute("value","Try!");
	answerButton.onclick = function(){
		checkAnswer();
	};

    document.getElementById("answerArea").appendChild(inputAnswer);
    document.getElementById("answerArea").appendChild(answerButton);
...
window.onload = function(){
    ...
    document.getElementById("inputArea").appendChild(inputPassword);
